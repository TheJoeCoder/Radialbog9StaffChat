...
public class SCInfoCommand extends Command {
	...
	public void execute(CommandSender sender, String[] args) {
		if(sender instanceof ProxiedPlayer) {
			...
			sender.sendMessage(new TextComponent(ChatColor.BLUE + PluginInfo.pluginName + ChatColor.WHITE + "v" +  PluginInfo.pluginVersion +" by " + ChatColor.GOLD + PluginInfo.pluginAuthor ));
			sender.sendMessage(new TextComponent(ChatColor.YELLOW + "Commands:"));
			sender.sendMessage(new TextComponent(ChatColor.RED + "/ao <message>" + ChatColor.WHITE + " - " + ChatColor.AQUA + "Allows you to talk in admin chat."));
		}
